...
const AboutUs = () => {
  ...
  return (
    <div>
      ...
      <h1 className='animate__animated animate__fadeInUp' style={{ textAlign: "center", color: webColor }}>About Us</h1>
      ...
      <div className='animate__animated animate__fadeInUp'>
        ...
        <h3 style={{ textAlign: "center", color: webColor }}>So We Did. </h3>
        ...
        <h3 style={{ textAlign: "center", color: webColor }}>We want to make things EASIER. </h3>
