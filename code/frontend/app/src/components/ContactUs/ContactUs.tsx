...
const ContactUs = () => {
    ...
    return (
        <div>
            ...
            <h1 className="animate__animated animate__bounceIn" style={{ textAlign: "center", color: iretroBrown }}>Need some help?</h1>
            ...
            <div className='animate__animated animate__fadeInUp'>
                ...
                <h3 style={{ textAlign: "center", color: iretroBrown }}>But sometimes... We run into some issues.</h3>
                <p style={{ textAlign: "center" }}>We are here for you by e-mail, and you can expect a response from us between 1-2 business days.
                </p>
                <a className='d-flex justify-content-center' href="mailto:alon.itzhaky@gmail.com" target="_blank" style={{color: iretroBrown}}>
                <FontAwesomeIcon icon={faEnvelope}/>
                </a>
                {showHR && <hr className="animate__animated animate__fadeInUp" />}
                <h3 style={{ textAlign: "center", color: iretroBrown }}>FAQ </h3>
